//* API e JSON *//
// JSON parse (JSON string para object) e stringify (Object para JSON string)
const json = 
{
  "trybers": [
    {
...
// Exemplo de criação de página com dados de um JSON
// Forçado por meio das crases para que o JSON inicie-se como do tipo string
const jsonInfo = `{
  "muitasEmpresasUsam": [
    "Google",
    "Twitter",
