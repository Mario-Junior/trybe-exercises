...
console.log(Exercise.greeter('Mário Júnior'));
console.log(Exercise.personAge('Mário Júnior', 40));
console.log(`A soma do array é igual a ${Exercise.sumArray([1, 3, 6, 12])}`);
