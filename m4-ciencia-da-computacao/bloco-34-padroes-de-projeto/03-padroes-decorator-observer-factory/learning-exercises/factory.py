...
# Dica: Em Python, é possível imprimir uma saída colorida.
# Para isso, basta a string começar com um código da cor antes
# e terminar com um código que indica o fim da formatação.
ROSA = "\033[95m"
ROXO = "\033[94m"
AZUL = "\033[96m"
VERDE = "\033[92m"
